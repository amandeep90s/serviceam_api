...
class SendPushNotification
{
    ...
    public function ProviderAssign($provider, $type = null)
    {
        ...
        return $this->sendPushToProvider(
            $provider,
            $type,
            trans("api.push.request_assign")
        );
    }
     ...
     * @return void
     */
    public function sendPushToProvider(
        $provider_id,
        $topic,
        $push_message,
        $title = null,
    ...
    public function ProviderWaiting($user_id, $status, $type = null)
    {
        ...
        if ($status == 1) {
            return $this->sendPushToUser(
                $user_id,
                $type,
                trans("api.push.provider_waiting_start"),
                "Provider Waiting"
            );
        } else {
            return $this->sendPushToUser(
                $user_id,
                $type,
                trans("api.push.provider_waiting_end"),
                "Provider Waiting"
            );
        }
    }
    ...
    public function ProviderCancelRide($request, $type = null)
    {
        ...
        return $this->sendPushToUser(
            $request->user_id,
            $type,
            trans("api.push.provider_cancelled"),
            "Provider Cancelled Ride"
        );
    }
    ...
    public function ProviderNotAvailable($user_id, $type = null)
    {
        ...
        return $this->sendPushToUser(
            $user_id,
            $type,
            trans("api.push.provider_not_available")
        );
    }

    public function adminAddamount(
        $provider_id,
        $type = null,
        $message,
        $amount
    )
    {
        ...
        return $this->sendPushToProvider(
            $provider_id,
            $type,
            $message . " " . $provider->currency_symbol . $amount
        );
    }
    ...
    public function DocumentsVerfied($provider_id, $type = null)
    {
        ...
        return $this->sendPushToProvider(
            $provider_id,
            $type,
            trans("api.push.document_verfied")
        );
    }
    ...
    )
    {
        ...
        return $this->sendPushToUser(
            $user_id,
            $type,
            $money . " " . trans("api.push.added_money_to_wallet"),
            $title,
            $data
        );
    }

    public function ProviderWalletMoney(
        $user_id,
        $money,
        $type = null,
        $title = null,
    ...
    public function ChargedWalletMoney($user_id, $money, $type = null)
    {
        ...
        return $this->sendPushToUser(
            $user_id,
            $type,
            $money . " " . trans("api.push.charged_from_wallet")
        );
    }
    ...
    public function provider_hold($provider_id, $type = null)
    {
        ...
        return $this->sendPushToProvider(
            $provider_id,
            $type,
            trans("api.push.provider_status_hold")
        );
    }

    public function provider_documents_notify($provider_id, $type = null)
    {
        $provider = Provider::where("id", $provider_id)->first();
        if ($provider->language) {
            $language = $provider->language;
        ...
        return $this->sendPushToProvider(
            $provider_id,
            $type,
            trans("api.push.provider_documents_notify")
        );
    }
    ...
    public function serviceIncomingRequest($provider, $type = null)
    {
        ...
        return $this->sendPushToProvider(
            $provider->id,
            $type,
            trans("api.push.service.incoming_request")
        );
    }
    ...
    public function serviceProviderNotAvailable($user_id, $type = null)
    {
        ...
        return $this->sendPushToUser(
            $user_id,
            $type,
            trans("api.push.service.provider_not_available")
        );
    }
    ...
    public function serviceProviderArrived($request, $type = null)
    {
        if ($request != null) {
            ...
            $language = $user->language;
            app("translator")->setLocale($language);
            $serviceAlias = isset($request->service->serviceCategory)
                ? $request->service->serviceCategory->alias_name
                : "";
    ...
    public function serviceProviderComplete($request, $type = null)
    {
        ...
        return $this->sendPushToUser(
            $request->user_id,
            $type,
            trans("api.push.service.complete")
        );
    }
    ...
    public function serviceProviderPickedup($request, $type = null)
    {
        ...
        return $this->sendPushToUser(
            $request->user_id,
            $type,
            trans("api.push.service.pickedup")
        );
    }
    ...
    public function serviceProviderDropped($request, $type = null)
    {
        ...
        return $this->sendPushToUser(
            $request->user_id,
            $type,
            trans("api.push.service.dropped") .
            " " .
            $request->currency .
            $request->payment->total .
            " by " .
    ...
    public function serviceProviderConfirmPay($request, $type = null)
    {
        ...
        return $this->sendPushToUser(
            $request->user_id,
            $type,
            trans("api.push.service.confirmpay") .
            " " .
            $request->currency .
            $request->payment->total .
            " by " .
    ...
    public function orderProviderStarted($request, $type = null)
    {
        ...
        return $this->sendPushToUser(
            $request->user_id,
            $type,
            trans("api.push.order.started") .
            " " .
            $request->currency .
            $request->orderInvoice->total_amount .
            " by " .
            $request->orderInvoice->payment_mode
        );
    }
    ...
    public function orderProviderConfirmPay($request, $type = null)
    {
        ...
        return $this->sendPushToUser(
            $request->user_id,
            $type,
            trans("api.push.order.confirmpay") .
            "  " .
            $request->currency .
            $request->orderInvoice->total_amount .
            " by " .
