...
<table class="nl-container"
       style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #f4f4fb;width: 100%"
    ...
    <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td align="center" style="background-color: #fef5e3;"><![endif]-->
                                ...
                                <div
                                    ...
                                    <div align="center" class="img-container center  autowidth  fullwidth "
                                        ...
                                        <img class="center  autowidth  fullwidth" align="center" border="0"
                                             src="{{$message->embed(app()->basePath().'/public/images/mail/rounder-up.png')}}"
                            ...
                            <div style="background-color: transparent; width: 100% !important;">
                                ...
                                <div
                                    ...
                                    <div align="center" class="img-container center fixedwidth "
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr style="line-height:0px;line-height:0px;">
                                                <td style="padding-right: 20px; padding-left: 20px;" align="center">
                                        <![endif]-->
                                        <div style="line-height:20px;font-size:1px">&#160;</div>
                                        <img class="center fixedwidth" align="center" border="0" src="" alt="Image"
                                             title="Image"
                                             style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 150px"
                                             width="150">
                                        <div style="line-height:20px;font-size:1px">&#160;</div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
